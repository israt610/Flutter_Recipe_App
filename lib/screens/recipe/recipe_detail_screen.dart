...
class _RecipeDetailScreenState extends State<RecipeDetailScreen> {
  ...
  int _currentReviewCount = 32;
  final TextEditingController _reviewController = TextEditingController();
  final List<Map<String, dynamic>> _userReviews = [];

  static Recipe _defaultSampleRecipe() {
    return Recipe(
      id: 'sample_paneer_butter',
      title: 'Butter Paneer',
      description:
          'Rich and creamy cottage cheese cubes simmered in a velvety tomato, butter, and cashew gravy.',
      imageUrl:
  ...
  void initState() {
    super.initState();
    _item = widget.recipe ?? _defaultSampleRecipe();
    ...
    if (!_isInitialized) {
      try {
        ...
        if (recipeFromArgs != null) {
          _item = recipeFromArgs;
          _servings = _item.servings > 0 ? _item.servings : 1;
          _currentRating = _item.rating;
          _currentReviewCount = _item.reviewCount;
        }
      } catch (e) {
        debugPrint('[RECIPE DETAIL] Error resolving route arguments: $e');
      } finally {
        _isInitialized = true;
      }
    }
  ...
  void _submitReview() {
    ...
    setState(() {
      ...
      _currentReviewCount++;
      _currentRating =
          ((_currentRating * (_currentReviewCount - 1)) + _selectedRating) / _currentReviewCount;
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            if (currentStep < steps.length - 1) {
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(
                                const SnackBar(
                                  content: Text('🎉 Bon Appétit! You completed cooking this recipe!'),
                                ),
                              );
                            }
                          },
                          ...
                          child: Text(
                            currentStep < steps.length - 1 ? 'Next Step' : 'Finish Cooking',
                          ),
                        ),
                      ),
                    ],
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: CustomScrollView(
        ...
        slivers: [
          // 1. Collapsible Hero Image SliverAppBar
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              background: _item.imageUrl.trim().isEmpty
                  ? Container(
          ...
          // 2. White Sheet Body Content Sliver
          SliverToBoxAdapter(
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // Metadata Cards (Calories, Cooking Time, Difficulty)
                  Row(
                    children: [
                      _buildMetaBadge(
                        Icons.bolt_rounded,
                  ...
                  Row(
                    children: [
                      const Icon(Icons.star_rounded, size: 20, color: AppColors.starRating),
                  ...
                  // Ingredients Header & Serving Counter
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Column(
                  ...
                  // Dynamically Scaled Ingredients List
      ...
      // Fixed Bottom Action Bar (Start Cooking & Favorite Heart)
